...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        Car carUser1 = new Car("Mazda", 6);
        Car carUser2 = new Car("BMW", 320);
        Car carUser3 = new Car("Audi", 5);
        Car carUser4 = new Car("VAZ", 2106);
        ...
        List<User> users1 = userService.getUserCar("Mazda", 6);
